...
3. Get the Storage Account Key
   ...
   **Expected output:**
   ...
   `pPavPdsPl1Zn5cchl41ouLiNxlZR+mgUscN7ToaY/EyiRHOoqEcToXsfAgs+TrPIYzIczLIjBWlP+ASt8iuycA==`
   
   **Copy the key and export it:**

   ```sh
   export AZURE_STORAGE_KEY="pPavPdsPl1Zn5cchl41ouLiNxlZR+mgUscN7ToaY/EyiRHOoqEcToXsfAgs+TrPIYzIczLIjBWlP+ASt8iuycA=="
   ```
