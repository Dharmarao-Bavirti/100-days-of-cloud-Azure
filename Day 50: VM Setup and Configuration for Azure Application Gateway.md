...
1. **Copy the public IP or DNS name of `datacenter-apgw`.**
   ...
   <img width="829" height="235" alt="image" src="https://github.com/user-attachments/assets/4237ce14-afe3-4c65-8580-38d6d8379fa3" />

2. **Open the URL in a browser.** **Refresh multiple times to observe traffic switching between `Version 1` and `Version 2`.**

   <img width="1258" height="149" alt="image" src="https://github.com/user-attachments/assets/44eb9ab7-6625-4897-bb35-a886060a08c7" />

   <img width="1254" height="153" alt="image" src="https://github.com/user-attachments/assets/cadb3d1a-fd91-4928-b1f0-bf7273f709b2" />
